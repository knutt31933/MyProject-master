...
public class Database2 extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        attvalue730.put("AttitudeID",9730);
        ...
        attvalue826.put("AttitudeID",1090);
